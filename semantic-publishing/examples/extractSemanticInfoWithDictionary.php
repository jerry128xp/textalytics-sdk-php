<?php // extractSemanticInfoWithDictionary.php 
 ...
 * analysis has been finished, the dictionary will be deleted.
 *
...
$response = $textalytics->analyzeDocument($doc, '', 'n', $dictionary_name, ''); 
if($response)
...
////////////////// Option 2 //////////////////
$response = $textalytics->analyzeText($text, $language, $dictionary_name, '');
if($response)
  if(isset($response->result))
    echo $response->result->toString()."\n";
